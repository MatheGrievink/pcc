...
| dictionary_1 = {'key1': 'value1', 'key2': 'value2'}<br />dictionary_2 = {'key1': 'value1', 'key2': 'value2'}<br />dictionaries = [dictionary_1, dictionary_2]<br />for dictionary in dictionaries:<br />&nbsp;print(dictionary) | Create a list of dictionaries | alien_1 = {'color': 'green', 'points': '5'}<br />alien_2 = {'color': 'yellow', 'points': '10'}<br />aliens = [alien_1, alien_2]<br />for alien in aliens:<br />&nbsp;print(alien) |